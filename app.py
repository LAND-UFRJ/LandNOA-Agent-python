...
if not active_collection_name:
  ...
  with tab2:
    ...
    elif technical_retrieval_method == "multi_query_reranker":
      retrieval_params['n_queries'] = st.number_input("Number of Queries (variations)", min_value=2, max_value=10, value=5, step=1) # Default maior p/ reranker
    ...
    elif technical_retrieval_method == "sentence_window_retriever_reranker":
